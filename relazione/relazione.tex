...
La preparazione dei dati è uno step cruciale per garantire la convergenza degli algoritmi ed evitare errori di calcolo. Di seguito descriviamo in modo dettagliato le operazioni effettuate, focalizzandoci sui quesiti teorici emersi in sede d'esame.
...
L'ispezione della Tabella \ref{tab:classification_results} evidenzia risultati estremamente interessanti ai fini dell'esame orale:
\begin{enumerate}
